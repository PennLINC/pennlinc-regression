...
control =['sex','meanFD','abcd_site']
network = sys.argv[1]
outdir = sys.argv[2]
os.makedirs(outdir,exist_ok=True)
"""
load the subject measures, strip the leading NDAR 
"""
phenotypes = pd.read_csv('/gpfs/fs001/cbica/projects/abcdfnets/data_for_ridge.csv') #load
