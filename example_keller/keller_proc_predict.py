...
"""
os.system('python /{0}/preprocess.py {1} {2}'.format(homedir,network,tmpdir))

working_dir = homedir + '/results/{0}_network/'.format(network)
...
"""
os.system('python /{0}/predict.py {1} {2} {3} {4} {5} rel_family_id'.format(homedir,working_dir,feature_path,phenotype_path,phenotype_name,control_path))